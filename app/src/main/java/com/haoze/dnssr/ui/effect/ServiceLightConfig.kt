...
internal enum class ServiceLightDeviceType { PHONE, PAD }

internal data class ServiceLightConfig(
...
internal object ServiceLightConfigs {
    private val PHONE_LIGHT = ServiceLightConfig(
    ...
    private val PHONE_DARK = ServiceLightConfig(
        points = floatArrayOf(0.8f, 0.2f, 1f, 0.8f, 0.9f, 1f, 0.2f, 0.9f, 1f, 0.2f, 0.2f, 1f),
    ...
    private val PAD_LIGHT = ServiceLightConfig(
        points = floatArrayOf(0.8f, 0.2f, 1f, 0.8f, 0.9f, 1f, 0.2f, 0.9f, 1f, 0.2f, 0.2f, 1f),
    ...
    private val PAD_DARK = ServiceLightConfig(
        points = floatArrayOf(0.8f, 0.2f, 1f, 0.8f, 0.9f, 1f, 0.2f, 0.9f, 1f, 0.2f, 0.2f, 1f),
    ...
    fun get(deviceType: ServiceLightDeviceType, darkTheme: Boolean): ServiceLightConfig =
        when (deviceType) {
            ServiceLightDeviceType.PHONE -> if (darkTheme) PHONE_DARK else PHONE_LIGHT
            ServiceLightDeviceType.PAD -> if (darkTheme) PAD_DARK else PAD_LIGHT
        }
}
